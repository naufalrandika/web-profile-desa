...
var Source = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Source, [{
    ...
    value: function reloadAllTile() {
      var _this$tileset;
      (_this$tileset = this.tileset) === null || _this$tileset === void 0 ? void 0 : _this$tileset.reloadAll();
    }
  }, {
    key: "reloadTilebyId",
    value: function reloadTilebyId(z, x, y) {
      var _this$tileset2;
      (_this$tileset2 = this.tileset) === null || _this$tileset2 === void 0 ? void 0 : _this$tileset2.reloadTileById(z, x, y);
    }
  }, {
    key: "reloadTileByLnglat",
    value: function reloadTileByLnglat(lng, lat, z) {
      var _this$tileset3;
      (_this$tileset3 = this.tileset) === null || _this$tileset3 === void 0 ? void 0 : _this$tileset3.reloadTileByLnglat(lng, lat, z);
    }
  }, {
    key: "getTileExtent",
    ...
    value: function reloadTileByExtent(bounds, z) {
      var _this$tileset6;
      (_this$tileset6 = this.tileset) === null || _this$tileset6 === void 0 ? void 0 : _this$tileset6.reloadTileByExtent(bounds, z);
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      // @ts-ignore
      this.data = null;
      (_this$tileset7 = this.tileset) === null || _this$tileset7 === void 0 ? void 0 : _this$tileset7.destroy();
    }
  }, {
    key: "processData",
    value: function () {
