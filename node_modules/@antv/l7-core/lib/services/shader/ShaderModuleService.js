...
/* babel-plugin-inline-import '../../shaders/common_attr.vert.glsl' */
var commom_attr_vert = "#ifdef USE_ATTRIBUTE_OPACITY\n  attribute float a_Opacity;\n#endif\n\n#ifdef USE_ATTRIBUTE_OFFSETS\n  attribute vec2 a_Offsets;\n#endif\n\n#ifdef USE_ATTRIBUTE_STROKE\n  attribute vec4 a_Stroke;\n#endif";
...
/* babel-plugin-inline-import '../../shaders/opacity_attr.vert.glsl' */
var opacity_attr_vert = "float opacity = u_opacity;\n\n#ifdef USE_ATTRIBUTE_OPACITY\n    opacity = a_Opacity;\n#endif";
...
var ShaderModuleService = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ShaderModuleService, [{
    ...
    value: function registerBuiltinModules() {
      ...
      this.registerModule('commom_attr_vert', {
        vs: commom_attr_vert,
        fs: ''
      });
      this.registerModule('opacity_attr_vert', {
        vs: opacity_attr_vert,
        fs: ''
      });
    }
  }, {
    ...
    value: function getModule(moduleName) {
      ...
      if (inject !== null && inject !== void 0 && inject['vs:#decl']) {
        ...
        declaredUniforms = (0, _shaderModule.extractUniforms)(inject === null || inject === void 0 ? void 0 : inject['vs:#decl']).uniforms;
      }
      ...
      }, (0, _objectSpread2.default)({}, declaredUniforms));
