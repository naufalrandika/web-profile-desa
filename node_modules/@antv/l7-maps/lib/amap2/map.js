...
var AMapService = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function (_AMapBaseService) {
  ...
  (0, _createClass2.default)(AMapService, [{
    ...
    function setCustomCoordCenter(center) {
      ...
      this.sceneCenterMercator = _l7Utils.amap2Project.apply(void 0, (0, _toConsumableArray2.default)(center));
    }
  }, {
    ...
    value: function coordToAMap2RelativeCoordinates(lnglatArray, layerCenter) {
      var _this2 = this;
      var layerCenterMercator = (0, _l7Utils.amap2Project)(layerCenter[0], layerCenter[1]);
