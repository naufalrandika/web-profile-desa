...
export default class AMapService extends AMapBaseService {
    ...
    lngLatToCoordByLayer(lnglat: number[], layerCenterMercator: [number, number]): [number, number];
    coordToAMap2RelativeCoordinates(lnglatArray: number[][][] | number[][] | number[], layerCenter: [number, number]): number[][][] | number[][] | number[];
