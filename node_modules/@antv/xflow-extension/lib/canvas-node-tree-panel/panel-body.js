...
var NodePanelBody = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "".concat(prefixClz, "-body"), style: props.style },
            ...
            state.searchList.length > 0 && (react_1.default.createElement("ul", { className: "".concat(prefixClz, "-body-list") }, state.searchList.map(function (treeNode) { return (react_1.default.createElement("li", { key: treeNode.id, className: "".concat(prefixClz, "-body-list-item") },
