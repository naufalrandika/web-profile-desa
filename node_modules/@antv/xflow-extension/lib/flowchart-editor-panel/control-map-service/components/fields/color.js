...
var ColorPicker = function (props) {
    var label = props.label, _a = props.value, value = _a === void 0 ? '' : _a, onChange = props.onChange, getContainer = props.getContainer;
    ...
    var createPickColorContainer = function () {
        var _a;
        var container = (_a = getContainer === null || getContainer === void 0 ? void 0 : getContainer()) !== null && _a !== void 0 ? _a : getParentContainerByClassName(containerRef.current, 'flowchart-editor-panel-body');
        return (0, react_dom_1.createPortal)(react_1.default.createElement(PickContainer, null), container);
    };
