...
var HexbinLayer = /** @class */ (function (_super) {
    __extends(HexbinLayer, _super);
    function HexbinLayer(options) {
        var _this = _super.call(this, options) || this;
        /**
         * 图层类型
         */
        _this.type = PlotLayer.LayerType.HexbinLayer;
        /**
         * 图层是否具有交互属性
         */
     ...
     * 图层配置项 Keys
     */
    HexbinLayer.LayerOptionsKeys = PlotLayer.LayerConfigkeys.concat(LAYER_OPTIONS_KEYS);
    return HexbinLayer;
}(PlotLayer));
export { HexbinLayer };
