 ...
 */
type OmitPlotOptions<T> = Omit<T, 'map' | 'width' | 'height' | 'antialias' | 'preserveDrawingBuffer' | 'logo' | 'theme' | 'zoom' | 'scale'>;
/**
 * plots 类型
 */
 ...
 * plots 的 class
 */
export declare const PLOTS_MAP: {
    dot: typeof Dot;
    dotDensity: typeof DotDensity;
 ...
 */
export declare const LAYERS_MAP: {
    textLayer: typeof TextLayer;
    dotLayer: typeof DotLayer;
    iconLayer: typeof IconLayer;
    dotDensityLayer: typeof DotDensityLayer;
    columnLayer: typeof ColumnLayer;
    heatmapLayer: typeof HeatmapLayer;
    gridLayer: typeof GridLayer;
    hexbinLayer: typeof HexbinLayer;
    pathLayer: typeof PathLayer;
    arcLayer: typeof ArcLayer;
    areaLayer: typeof AreaLayer;
    prismLayer: typeof PrismLayer;
};
export {};
