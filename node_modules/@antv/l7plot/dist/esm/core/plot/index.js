...
var Plot = /** @class */ (function (_super) {
    ...
    Plot.prototype.createSource = function () {
        var _a = this.options.source, data = _a.data, aggregation = _a.aggregation, sourceCFG = __rest(_a, ["data", "aggregation"]);
    ...
    Plot.prototype.createLabelLayer = function (source, label, plotLayerConfig) {
        ...
        var textLayer = new TextLayer(__assign({ name: 'labelLayer', visible: visible, minZoom: minZoom, maxZoom: maxZoom, zIndex: zIndex + 0.1, source: source }, label));
        return textLayer;
    };
    /**
     * 更新数据标签图层
    ...
    Plot.prototype.updateLabelLayer = function (source, label, plotLayerConfig, labelLayer) {
        if (label) {
            if (labelLayer) {
                labelLayer.update(__assign({}, label));
            }
            else {
    ...
    Plot.prototype.update = function (options) {
        ...
        if (options.source && !isEqual(this.lastOptions.source, this.options.source)) {
            var _a = options.source, data = _a.data, sourceConfig = __rest(_a, ["data"]);
    ...
    Plot.prototype.changeData = function (data, cfg) {
        ...
        var _a = this.options.source, aggregation = _a.aggregation, sourceCFG = __rest(_a, ["aggregation"]);
        aggregation && MappingSource.aggregation(sourceCFG, aggregation);
