...
var AreaLayer = /** @class */ (function (_super) {
    ...
    function AreaLayer(options) {
        ...
        _this.layer = new l7_1.PolygonLayer(tslib_1.__assign(tslib_1.__assign({}, config), { name: _this.name }));
        _this.strokeLayer = new l7_1.LineLayer({ name: 'strokeLayer', visible: visible, zIndex: zIndex, minZoom: minZoom, maxZoom: maxZoom });
        _this.highlightLayer = new l7_1.LineLayer({
            name: 'highlightLayer',
        ...
        _this.selectFillLayer = new l7_1.PolygonLayer({
        ...
        _this.selectStrokeLayer = new l7_1.LineLayer({
