...
/** createTheme 主题样式表配置 */
export type StyleSheetCfg = Pick<StyleSheet, 'mapStyle' | 'subColor' | 'brandColor' | 'paletteQualitative10' | 'paletteQualitative20' | 'paletteSemanticRed' | 'paletteSemanticGreen' | 'paletteSemanticYellow' | 'paletteSequence' | 'fontFamily'>;
