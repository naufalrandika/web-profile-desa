...
import type { LabelOptions, LegendOptions } from '../../types';
import { ChoroplethOptions, ChoroplethSourceOptions, DrillStack, DrillStepConfig, FeatureCollection, ViewLevel } from './types';
...
export declare class Choropleth extends Plot<ChoroplethOptions> {
     ...
     * 港澳界图层
     */
    chinaHkmBoundaryLayer: PathLayer | undefined;
    /**
     * 国界争议图层
     */
    ...
    protected parserSourceConfig(source: ChoroplethSourceOptions): {
        ...
        sourceCFG: {
            transforms?: import("@antv/l7").ITransform[] | undefined;
        };
    };
    /**
     * 创建 source 实例
     ...
     * 获取当前已钻取层级数据
     */
    getCurrentDrillSteps(): Required<ViewLevel>[];
    /**
     * 实现 legend 配置项
     */
     ...
     * 向上钻取方法
     */
    drillUp(config?: DrillStepConfig, level?: ViewLevel['level']): void;
    /**
     * 更新显示区域
     */
