...
import { GaodeMap, GaodeMapV1, Map as L7Map, Mapbox, Scale, Scene, Zoom } from '@antv/l7';
import { Legend } from '../../component/legend';
import { Tooltip } from '../../component/tooltip';
import type { AMapInstance, Bounds, IPlotLayer, LayerMenuControlOptions, LegendOptions, MapboxInstance, MapInstance, MapOptions, MapStatusOptions, ScaleControlOptions, UpdateMapConfig, ZoomControlOptions } from '../../types';
...
export declare abstract class Map<O extends MapOptions> extends EventEmitter {
     ...
     * 创建 map 容器
     */
    protected createMap(): GaodeMap | GaodeMapV1 | Mapbox | L7Map;
    /**
     * 创建 scene 实例
     */
     ...
     * 获取 map 实例
     */
    getMap(): MapboxInstance | AMapInstance | MapInstance | unknown;
    /**
     * 添加图层
     */
     ...
     * 可用来关闭地图的一些交互操作
     */
    setMapStatus(status: Partial<MapStatusOptions>): void;
    /**
     * 设置场景的背景色
     */
