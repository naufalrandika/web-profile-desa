  ...
  (0, _createClass2.default)(BaseLayer, [{
    ...
    value: function encodeStyle(options) {
      ...
      Object.keys(options).forEach(function (key) {
        if (
        // 需要数据映射
        [_this6.enableShaderEncodeStyles].concat((0, _toConsumableArray2.default)(_this6.enableDataEncodeStyles)).includes(key) && (0, _lodash.isPlainObject)(options[key]) && (options[key].field || options[key].value) && !(0, _lodash.isEqual)(_this6.encodeStyleAttribute[key], options[key]) // 防止计算属性重复计算
        ) {
