...
var edge2Json = function (cell) {
    var data = cell.getData() || {};
    return tslib_1.__assign(tslib_1.__assign({}, data), { id: cell.id, source: cell.getSourceCellId(), target: cell.getTargetCellId(), sourcePortId: cell.getSourcePortId(), targetPortId: cell.getTargetPortId(), sourcePort: cell.getSourcePortId(), targetPort: cell.getTargetPortId() });
};
