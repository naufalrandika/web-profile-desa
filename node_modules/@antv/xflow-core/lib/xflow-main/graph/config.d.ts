...
export declare class GraphConfig {
    ...
    setDefaultNodeRender: (component: React.ComponentType<NsGraph.IReactNodeProps<T>>) => void;
    setDefaultEdgeRender: (component: React.ComponentType<NsGraph.IReactEdgeProps<T>>) => void;
    setNodeRender: (renderKey: string, component: React.ComponentType<NsGraph.IReactNodeProps<T>>) => void;
    setEdgeRender: (renderKey: string, component: React.ComponentType<NsGraph.IReactEdgeProps<T>>) => void;
...
export declare const createGraphConfig: <T = any>(addOptions: (config: GraphConfig, proxy: IValueProxy<T>) => void) => (props?: T) => any;
export {};
