...
declare type ProColumnsValueType = ProFieldValueType;
declare type TableRowEditable<T> = RowEditableConfig<T>;
export type { ProTableProps, IntlType, ActionType, EditableFormInstance, TableRowEditable, ColumnsState, ProColumnsValueType, ProColumns, ProColumnType, RequestData, ListToolBarProps, DragTableProps, };
