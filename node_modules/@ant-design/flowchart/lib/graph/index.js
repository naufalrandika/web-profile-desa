...
var Flowchart = function (props) {
    ...
    // miniMapProps = {},
    onAddNode = _a.onAddNode, onDelNode = _a.onDelNode, onCopy = _a.onCopy, onPaste = _a.onPaste, onAddEdge = _a.onAddEdge, onConfigChange = _a.onConfigChange, onDestroy = _a.onDestroy, onConfigReady = _a.onConfigReady, isAutoCenter = _a.isAutoCenter, data = _a.data, mode = _a.mode, onReady = _a.onReady;
    ...
    var menuConfig = (0, menu_1.useMenuConfig)(__assign(__assign({}, contextMenuPanelProps), { onDelNode: onDelNode }));
    var commandConfig = (0, service_1.useCmdConfig)({
        flowchartId: uuidv4Ref.current,
    }); // 需要 getProps
    var keybindingConfig = keyBindingProps || (0, service_1.useKeybindingConfig)({ onDelNode: onDelNode, onCopy: onCopy, onPaste: onPaste });
    ...
    return (react_1.default.createElement(context_1.default.Provider, { value: { flowchartId: uuidv4Ref.current } },
        react_1.default.createElement("div", { className: "xflow-canvas-container", "data-flowchart-id": uuidv4Ref.current, ref: container, style: { width: '100%', height: '100%', backgroundColor: '#fff' } },
            react_1.default.createElement(xflow_1.XFlow, { className: className, style: style, commandConfig: commandConfig, onAppDestroy: onDestroy, isAutoCenter: isAutoCenter, onAppConfigReady: onConfigReady, onLoad: function (app) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                react_1.default.createElement(xflow_1.FlowchartCanvas, { config: canvasProps.config, mode: mode, onAddNode: onAddNode, onAddEdge: onAddEdge, onConfigChange: onConfigChange, position: position, showPortsOnNodeSelected: showPortsOnNodeSelected, edgeConfig: edgeConfig },
