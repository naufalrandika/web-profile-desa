...
import { IGraphCommandService, IModelService, NsGraph, IPosition, NsJsonSchemaForm, IToolbarLayout, IAppDestroy, IAppConfigReady, IApplication, KeybindingConfig, IFlowchartGraphProps, IFlowchartNodePanelProps } from '@antv/xflow';
...
export type Command = 'undo-cmd' | 'redo-cmd' | 'front-node' | 'back-node' | 'save-graph-data' | 'multi-select' | 'add-group' | 'del-group' | 'graph-toggle-multi-select' | 'graph-copy-selection' | 'graph-paste-selection';
