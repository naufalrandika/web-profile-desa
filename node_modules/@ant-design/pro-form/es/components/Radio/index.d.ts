...
export declare type ProFormRadioGroupProps = ProFormFieldItemProps<RadioGroupProps, HTMLDivElement> & {
...
declare const ProFormRadio: React.ComponentClass<{
    fieldProps?: (import("../../interface").FieldProps<any> & RadioProps) | undefined;
...
} & Omit<import("..").ProFormItemProps, "valueType"> & Pick<import("../../interface").ProFormGridConfig, "colProps"> & import("../../interface").ExtendsProps & {
