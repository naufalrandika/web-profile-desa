...
export declare type ProFormCheckboxGroupProps = ProFormFieldItemProps<CheckboxGroupProps, HTMLInputElement> & {
    layout?: 'horizontal' | 'vertical';
    options?: CheckboxGroupProps['options'];
} & ProFormFieldRemoteProps;
declare const CheckboxGroup: React.FC<ProFormCheckboxGroupProps>;
export declare type ProFormCheckboxProps = ProFormFieldItemProps<CheckboxProps, HTMLInputElement>;
/**
 * 多选框的
 *
 * @param
