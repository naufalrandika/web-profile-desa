...
export interface BasicRouteProps<Params extends {
    [K in keyof Params]?: string;
} = Record<string, any>, C extends StaticContext = StaticContext, S = H.LocationState> {
    history: H.History<S>;
...
export declare type RouterTypes<P extends {}> = {
