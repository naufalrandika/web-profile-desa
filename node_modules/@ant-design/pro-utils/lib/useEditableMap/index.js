...
function useEditableMap(props) {
  var editableType = props.type || 'single'; // Internationalization
  ...
  var isEditable = (0, _react.useCallback)(function (recordKey) {
    if (editableKeys === null || editableKeys === void 0 ? void 0 : editableKeys.includes((0, _useEditableArray.recordKeyToString)(recordKey))) return true;
    return false;
  }, [(editableKeys || []).join(',')]);
  /**
   * 进入编辑状态
  ...
  var startEditable = function startEditable(recordKey) {
    ...
    if (editableKeysSet.size > 0 && editableType === 'single') {
      _message2.default.warn(props.onlyOneLineEditorAlertMessage || intl.getMessage('editableTable.onlyOneLineEditor', '只能同时编辑一行'));
  ...
  var onCancel = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/(0, _regeneratorRuntime2.default)().mark(function _callee(recordKey, editRow, originRow, newLine) {
      var _props$onCancel;
  ...
  var onSave = /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/(0, _regeneratorRuntime2.default)().mark(function _callee2(recordKey, editRow, originRow) {
      var _props$onSave;
