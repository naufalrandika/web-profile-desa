...
export declare type ProFieldTextType = React.ReactNode | React.ReactNode[] | Record<string, any> | Record<string, any>[];
export declare type SearchTransformKeyFn = (value: any, namePath: string, allValues: any) => string | Record<string, any>;
export declare type SearchConvertKeyFn = (value: any, field: NamePath) => string | Record<string, any>;
export declare type ProTableEditableFnType<T> = (value: any, record: T, index: number) => boolean;
/** 支持的变形，还未完全支持完毕 */
...
export declare type ProSchema<Entity = Record<string, any>, ExtraProps = unknown, ComponentsType = ProSchemaComponentTypes, ValueType = 'text', ExtraFormItemProps = unknown> = {
    ...
    }, form: FormInstance, action?: Omit<UseEditableUtilType, 'newLineRecord' | 'editableKeys' | 'actionRender' | 'setEditableRowKeys'>) => React.ReactNode;
    /**
     *  @name 可编辑表格是否可编辑
     *
     * @example 不允许编辑
