...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.init = function () {
        ...
        var menu = (0, dom_util_1.createDom)("<div class=".concat(className || 'g6-component-contextmenu', "></div>"));
        (0, dom_util_1.modifyCSS)(menu, { top: '0px', position: 'absolute', visibility: 'hidden' });
    ...
    Menu.prototype.onMenuShow = function (e) {
        ...
        var menu = customContent(e, graph);
        (0, utils_1.render)(menu, menuDom);
        // 清除之前监听的事件
        this.removeMenuEventListener();
        var handleMenuClick = this.get('handleMenuClick');
        if (handleMenuClick) {
            var handleMenuClickWrapper = function (evt) {
        ...
        (0, dom_util_1.modifyCSS)(menuDom, {
            top: "".concat(y, "px"),
            left: "".concat(x, "px"),
            visibility: 'visible',
        });
    ...
    Menu.prototype.onMenuHide = function () {
        var menuDom = this.get('menu');
        if (menuDom) {
            (0, dom_util_1.modifyCSS)(menuDom, { visibility: 'hidden' });
        }
        // 隐藏菜单后需要移除事件监听
        this.removeMenuEventListener();
    };
