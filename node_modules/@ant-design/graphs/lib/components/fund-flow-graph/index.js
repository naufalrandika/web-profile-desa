...
var events_1 = require("../flow-analysis-graph/events");
(0, customItem_1.registerFundFlowItems)();
var defaultLayout = {
    type: 'dagre',
    rankdir: 'LR',
    nodesep: 30,
...
var FundFlowGraph = function (props) {
    ...
    var container = (0, useGraphs_1.default)('Graph', rest, { name: 'FundFlowGraph', bindEvents: events_1.bindEvents }).container;
