...
exports.transformOriginData = void 0;
...
var transformOriginNodes = function (originNodes, layerOrder, size) {
    ...
    return originNodes.map(function (originNode) {
        ...
        return {
            ...
            data: (0, lodash_1.cloneDeep)(originNode),
            x: originNode.x,
            y: originNode.y,
        };
    });
...
var transformOriginEdges = function (data, layerOrder, segmLayer, ratioMethod) {
    ...
    return originEdges
        ...
        return {
            ...
            data: (0, lodash_1.cloneDeep)(originEdge),
        };
    })
        .filter(function (edge) { return !!edge; });
};
// 数据转换：原始数据 -> G6渲染数据
var transformOriginData = function (originData, layerOrder, segmLayer, ratioMethod) {
    if (layerOrder === void 0) { layerOrder = []; }
    var _a = originData.nodes, originNodes = _a === void 0 ? [] : _a;
    // 节点去重
    var uniqNodes = (0, lodash_1.uniqBy)(originNodes, 'id');
    // 获取所有节点中最大的宽作为节点size
    var size = (0, text_1.getNodeMaxSize)(uniqNodes);
...
exports.transformOriginData = transformOriginData;
