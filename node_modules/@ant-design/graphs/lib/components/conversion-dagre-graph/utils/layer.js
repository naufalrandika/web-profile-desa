...
exports.removeLayerNameGroup = exports.drawLayerName = void 0;
// 在画布上绘制层级名称
var drawLayerName = function (graph, layerOrder, rankdir) {
    ...
    // 删除已有的层级名称容器分组
    (0, exports.removeLayerNameGroup)(graph);
    // 添加层级名称容器的分组
...
exports.drawLayerName = drawLayerName;
// 删除已有的层级名称分组
var removeLayerNameGroup = function (graph) {
    var group = graph.getGroup();
...
exports.removeLayerNameGroup = removeLayerNameGroup;
