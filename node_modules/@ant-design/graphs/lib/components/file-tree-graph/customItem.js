...
exports.registerFileTreeBehaviors = exports.registerFileTreeGeometries = void 0;
var g6_1 = __importDefault(require("@antv/g6"));
var utils_1 = require("../../utils");
var Util = g6_1.default.Util;
// file tree
var registerFileTreeGeometries = function () {
    ...
    g6_1.default.registerNode('file-tree-node', {
        options: {
            style: {
                fill: '#e8f7ff',
            },
        ...
        addCollapse: function (group, props) {
            ...
            var markerStyle = (0, utils_1.getStyle)(style, model, group, 'collapse');
        ...
        addMarker: function (group, props) {
            ...
            if (!show)
                return;
            // 子类数量 icon，绘制圆点在节点正下方
            var markerStyle = (0, utils_1.getStyle)(style, model, group);
            var config = __assign(__assign({}, defaultMarkerCfg), markerStyle);
            var _d = (0, utils_1.getMarkerPosition)(position, size), x = _d.x, y = _d.y;
            // 增加子节点 icon
            var markerIcon = group.addShape('marker', {
                attrs: __assign({ x: x + startX, y: y + startY, symbol: g6_1.default.Marker.expand }, config),
                name: 'icon-add-child',
            });
            markerIcon.hide();
            return markerIcon;
        ...
        draw: function (model, group) {
            ...
            var bottomLineStyle = (0, utils_1.getStyle)(lineStyle, model, group);
            ...
            if (customContent) {
                ...
                text = this.addName(group, {
                    ...
                    x: x + cardPadding[3],
                    y: height / 2,
                    style: (0, utils_1.getStyle)(label.style, model, group),
                });
            }
            ...
            if (!size.length)
                size = [width, height];
            var cardStyle = (0, utils_1.getStyle)(style, model, group);
            ...
            var graph = (0, utils_1.getGlobalInstance)(model._graphId);
            if (typeof markerCfg === 'function') {
                callbackMarkerCfg = markerCfg(__assign(__assign({}, model), { children: (0, utils_1.getChildrenData)(graph === null || graph === void 0 ? void 0 : graph.get('eventData').getData(), model.g_currentPath) }), group);
            }
            ...
            if (rootNode) {
                (0, utils_1.pushAsyncEvent)(model._graphId, function () {
            ...
            if (['closest', 'selected', 'hover'].includes(name)) {
                ...
                if (value) {
                    ...
                    if (selected) {
                        ...
                        var cardStyle = (0, utils_1.getStyle)(style, model, node);
                        var textStyle = (0, utils_1.getStyle)(lableStyle, model, node);
                        var pathStyle = (0, utils_1.getStyle)(lineStyle, model, node);
                        var markStyle_1 = (0, utils_1.getStyle)(markerCfg, model, node);
    ...
    g6_1.default.registerEdge('file-tree-edge', {
...
exports.registerFileTreeGeometries = registerFileTreeGeometries;
var registerFileTreeBehaviors = function () {
    g6_1.default.registerBehavior('wheel-scroll', {
    ...
    g6_1.default.registerBehavior('drag-branch', {
    ...
    g6_1.default.registerBehavior('click-node', {
        getEvents: function () {
            return {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            (0, utils_1.createFetchLoading)(model, fetchLoading);
    ...
    g6_1.default.registerBehavior('hover-node', {
        getEvents: function () {
            return {
...
exports.registerFileTreeBehaviors = registerFileTreeBehaviors;
