        ...
        draw: function (cfg, group) {
            ...
            if (title) {
                ...
                titleTextShape = group.addShape('text', {
                    attrs: __assign({ x: paddingArray[3], y: paddingArray[0], textBaseline: 'top', text: autoEllipsis && !autoWidth ? (0, utils_1.setEllipsis)(title, textStyle, contentWidth) : title }, textStyle),
                    name: 'title',
                    draggable: draggable,
                });
            ...
            if (markerCfg) {
                ...
                var getCollapsed_1 = function () {
                    var _a, _b;
                    if ((0, util_1.isBoolean)(stateCollapsed_1))
                        return stateCollapsed_1;
                    if (cfg._graphId.startsWith('FlowAnalysisGraph'))
                        return !((_a = cfg["".concat(constants_1.prefix, "_children")]) === null || _a === void 0 ? void 0 : _a.length);
