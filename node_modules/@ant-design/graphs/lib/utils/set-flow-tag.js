...
exports.setFlowTag = void 0;
var constants_1 = require("../constants");
var log_1 = require("./log");
/**
 * 对数据进行打标，加上 level
 */
var setFlowTag = function (data, limitLevel) {
    ...
    var getTarget = function (source) {
        return edges.filter(function (item) {
            ...
            if (used !== -1 && item.source === source) {
                ...
                log_1.Log.warn("The data [".concat(item.source, ",").concat(item.target, ",").concat((_a = loop[0]) === null || _a === void 0 ? void 0 : _a.source, "] is in a loop, please check the rationality."));
            }
    ...
    var appendInfo = function (item) {
        var _a;
        return (_a = {},
            _a["".concat(constants_1.prefix, "_level")] = level,
            _a["".concat(constants_1.prefix, "_parent")] = getSource(item.id).map(function (n) { return n.source; }),
            _a["".concat(constants_1.prefix, "_children")] = level < limitLevel - 1 ? getTarget(item.id).map(function (n) { return n.target; }) : [],
            _a);
    };
