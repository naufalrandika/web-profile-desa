...
import { ArrowConfig as G6ArrowConfig, Edge, EdgeConfig as G6EdgeConfig, Graph, IEdge, IG6GraphEvent, IGraph, ITreeGraph, IGroup, INode, IPoint, IShape, LabelStyle, ModelConfig, Node, NodeConfig as G6NodeConfig, ShapeStyle, StateStyles, TreeGraphData as G6TreeGraphData, GraphData, Item, TreeGraph } from '@antv/g6';
...
export type IShapeStyle = ShapeStyle | ((edge: Shape | ShapeCfg, graph: IGraph | IGroup | undefined, name?: string) => ShapeStyle);
export type ILabelStyle = LabelStyle | ((edge: Shape | ShapeCfg, graph: IGraph | IGroup | undefined, name?: string) => LabelStyle);
...
export interface ToolbarCfg extends Omit<PluginContainer<ToolbarCfgCustomContent>, 'container'> {
     ...
     * @deprecated
     */
    renderIcon?: ({ zoomIn, zoomOut, toggleFullscreen, fullscreen, graph, }: ToolbarCfgCustomContent) => React.ReactElement;
}
...
export type IMarkerCfg = MarkerCfg | MarkerCfg[] | ((cfg: CardNodeCfg, graph: IGraph | IGroup | undefined) => MarkerCfg | MarkerCfg[]);
...
export { StateStyles, ShapeStyle, Node, Edge, IGraph, ITreeGraph, ModelConfig, IG6GraphEvent, IGroup, LabelStyle, INode, IEdge, Graph, IPoint, IShape, G6TreeGraphData, GraphData, Item, TreeGraph, };
