...
var DagreFundFlowGraph = function (props) {
    var uProps = (0, utils_3.useProps)(props, defaultProps);
    ...
    var graphId = (0, utils_3.getGraphId)(graph);
    (0, useGraph_1.default)(graphs[graphId], uProps, container);
    (0, react_1.useEffect)(function () {
        var graphSize = (0, utils_3.getGraphSize)(width, height, container);
        ...
        (0, utils_3.renderMinimap)(minimapCfg, graph);
        var originData = (0, utils_2.deepClone)(data);
        ...
        (0, utils_3.bindEvents)(graph, props);
        return function () {
            if (graphs[graphId]) {
